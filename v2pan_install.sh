...
install_Dark-V2ay-Manager() {
    ...
    /usr/local/dark-v2ray/dark-v2ray setting -username root -password root
    /usr/local/dark-v2ray/dark-v2ray setting -port 34485
    rm -r /home/pannel_db/
    mkdir /home/pannel_db/
    touch /home/pannel_db/vmess.db
